...
/**
 * Item Model for quote.
 *
 * @package     Quote
 * @subpackage  Models
 */
class QuoteModelQuote extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_QUOTE';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_quote.quote';
	 ...
	 */
	public function getTable($type = 'Quote', $prefix = 'QuoteTable', $config = array())
	{
	...
	{
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('Quote.id');
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				if (empty($data))
				{
					JError::raiseError(404, JText::_('COM_QUOTE_ERROR_FEED_NOT_FOUND'));
				}
