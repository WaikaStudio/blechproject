...
var quoteAdmin = (function () {
  ...
  function q1() {
    var input = `<input type="number" data-o="1" id="quote_request" name="quote_request" value="" required style="width:50px">`;
    $('#quote_r').html(input);
  }

  function q2() {
    var input = `<input type="text" data-o="2" id="quote_request" name="quote_request" value="" required>`;
    $('#quote_r').html(input);
  }
  ...
  function init() {
    ...
    $("body").on('keyup', '#quote_request', getQuote);
